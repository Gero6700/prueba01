...
public class ConofegeBuilder {
    ...
    private static ConofegeRaw GenerateRaw() {
        return new Faker<ConofegeRaw>()
            ...
            .RuleFor(x => x.Offec, f => int.Parse(f.Date.Future(1, DateTime.Now).ToString("yyyyMMdd")))
            .RuleFor(x => x.Offec2, f => int.Parse(f.Date.Future(1, DateTime.Now.AddYears(2)).ToString("yyyyMMdd")))
            ...
            .RuleFor(x => x.Ofgrbd, f => int.Parse(f.Date.Future(1, DateTime.Now).ToString("yyyyMMdd")))
            .RuleFor(x => x.Ofgrbh, f => int.Parse(f.Date.Future(1, DateTime.Now.AddYears(2)).ToString("yyyyMMdd")))
