...
public class CreateCancellationPolicyLineShould {
    ...
    public async Task create_cancellation_policy_line() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .CreateCancellationPolicyLine(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.CancellationPolicyLine>(x => IsEquivalent(x, expectedCancellationPolicyLine)));
