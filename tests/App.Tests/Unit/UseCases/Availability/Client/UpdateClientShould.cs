...
public class UpdateClientShould {
    ...
    private UpdateIntegration updateClient = null!;

    [SetUp]
    public void SetUp() {
        availabilitySynchronizerApiClient = Substitute.For<IAvailabilitySynchronizerApiClient>();
        updateClient = new UpdateIntegration(availabilitySynchronizerApiClient);
    }
    ...
    public async Task update_client() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .UpdateClient(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.Client>(c => IsEquivalent(c, expectedClient)));
