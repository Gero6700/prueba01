...
public class CreateMarkupShould {
    ...
    public async Task create_markup() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .CreateMarkup(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.Markup>(x => IsEquivalent(x, expectedMarkup)));
    }
    ...
    [Test]
    public async Task do_not_create_markup_when_mkcfed_is_zero() {
        //Given
        const int anyMkcid = 1;
    ...
    [Test]
    public async Task do_not_create_markup_when_mkcfeh_is_zero() {
        //Given
        const int anyMkcid = 1;
        const int anyMkcfed = 20240601;
    ...
    [Test]
    public async Task do_not_create_markup_when_mkcbwh_is_less_than_mkcbwd() {
        //Given
        const int anyMkcid = 1;
        const int anyMkcfed = 20240601;
        const int anyMkcfeh = 20240602;
    ...
    [Test]
    public async Task do_not_create_markup_when_mkcfeh_is_less_than_mkcfed() {
        //Given
        const int anyMkcid = 1;
    ...
    [Test]
    public async Task do_not_create_markup_when_mkcpor_is_zero() {
        //Given
        const int anyMkcid = 1;
        const int anyMkcfed = 20240601;
        const int anyMkcfeh = 20240602;
