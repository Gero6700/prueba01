...
public class CreateOfferAndSupplementConfigurationPaxShould {
    ...
    private CreateOfferSupplementConfigurationPax createOfferAndSupplementConfigurationPax;

    [SetUp]
    public void SetUp() {
        availabilitySynchronizerApiClient = Substitute.For<IAvailabilitySynchronizerApiClient>();
        createOfferAndSupplementConfigurationPax = new CreateOfferSupplementConfigurationPax(availabilitySynchronizerApiClient);
    }
    ...
    public async Task create_offer_and_supplement_configuration_pax() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .CreateOfferAndSupplementConfigurationPax(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.OfferAndSupplementConfigurationPax>(x => IsEquivalent(x, expectedOfferAndSupplementConfigurationPax)));
    }
