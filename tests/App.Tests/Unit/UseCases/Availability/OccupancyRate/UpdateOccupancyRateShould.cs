...
public class UpdateOccupancyRateShould {
    ...
    public async Task update_occupancy_rate() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .UpdateOccupancyRate(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.OccupancyRate>(x => IsEquivalent(x, expectedOccupancyRate)));
    }
    ...
    [Test]
    public async Task do_not_update_occupancy_rate_when_cmaxad_is_less_than_cminad() {
        //Given
        var anyResthaco = new Resthaco {
            Cocod = "anyCocod",
            Cminad = 2,
    ...
    [Test]
    public async Task do_not_update_occupancy_rate_when_cmaxin_is_less_than_cminin() {
        //Given
        var anyResthaco = new Resthaco {
            Cocod = "anyCocod",
            Cminin = 2,
    ...
    [Test]
    public async Task do_not_update_occupancy_rate_when_cmaxto_is_less_than_cminto() {
        //Given
        var anyResthaco = new Resthaco {
            Cocod = "anyCocod",
            Cminto = 2,
