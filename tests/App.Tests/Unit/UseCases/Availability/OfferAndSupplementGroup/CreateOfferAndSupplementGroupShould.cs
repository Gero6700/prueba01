...
public class CreateOfferAndSupplementGroupShould {
    ...
    public async Task create_offer_and_supplement_group() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .CreateOfferAndSupplementGroup(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.OfferAndSupplementGroup>(x => IsEquivalent(x, expectedOfferAndSupplementGroup)));
    }
