...
public class UpdateHotelRoomConfigurationShould {
    ...
    public async Task update_hotel_room_configuration() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .UpdateHotelRoomConfiguration(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.HotelRoomConfiguration>(c => IsEquivalent(c, expectedHotelRoomConfiguration)));
    }
