...
public class DeleteHotelRoomConfigurationShould {
    ...
    public async Task delete_hotel_room_configuration() {
        ...
        await availabilitySynchronizerApiClient.Received()
            .DeleteHotelRoomConfiguration(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.HotelRoomConfiguration>(c => IsEquivalent(c, expectedHotelRoomConfiguration)));
    }
