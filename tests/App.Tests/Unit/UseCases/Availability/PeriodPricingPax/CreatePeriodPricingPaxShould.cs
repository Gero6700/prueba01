namespace Senator.As400.Cloud.Sync.App.Tests.Unit.UseCases.Availability.PeriodPricingPax;
...
public class CreatePeriodPricingPaxShould {
    ...
    public async Task create_period_pricing_pax() {
        ...
        //Then
        var expectedPeriodPricingPax = new Infrastructure.Dtos.BookingCenter.Availability.PeriodPricingPax {
            PaxOrder = 1,
        ...
        await availabilitySynchronizerApiClient.Received()
            .CreatePeriodPricingPax(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.PeriodPricingPax>(x => IsEquivalent(x, expectedPeriodPricingPax)));
    }
    ...
    [Test]
    public async Task do_not_create_period_pricing_pax_when_d4tipa_position_5_is_not_a_number() {
        //Given
    ...
    [Test]
    public async Task do_not_create_period_pricing_pax_when_d4has_is_less_than_d4desd() {
        //Given
        const string anyD4tipa = "ADULT1";
        const string anyD4tdto = "";
    ...
    [Test]
    public async Task do_not_create_period_pricing_pax_when_d4desd_is_negative() {
        //Given
        const string anyD4tipa = "ADULT1";
        const string anyD4tdto = "";
    ...
    [Test]
    public async Task do_not_create_period_pricing_pax_when_d4has_is_negative() {
        //Given
        const string anyD4tipa = "ADULT1";
        const string anyD4tdto = "";
        const decimal anyD4desd = 20.00m;
        const decimal anyD4has = -1.00m;
        const decimal anyD4dtos = 10.00m;
        const string anyCode = "anyCode";
        const string anyPeriodPricingCode = "anyPeriodPricingCode";
