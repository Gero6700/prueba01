namespace Senator.As400.Cloud.Sync.App.Tests.Unit.UseCases.Availability.MinimumStay;
...
public class UpdateMinimumStayShould {
    ...
    public async Task update_minimum_stay() {
        ...
        //Then
        var expectedConestmi = new Infrastructure.Dtos.BookingCenter.Availability.MinimumStay {
        ...
        await availabilitySynchronizerApiClient.Received().
            UpdateMinimumStay(Arg.Is<Infrastructure.Dtos.BookingCenter.Availability.MinimumStay>(x => IsEquivalent(x, expectedConestmi)));
