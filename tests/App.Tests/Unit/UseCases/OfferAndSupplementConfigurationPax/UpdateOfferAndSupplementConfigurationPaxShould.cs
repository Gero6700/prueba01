...
public class UpdateOfferAndSupplementConfigurationPaxShould {
    ...
    [Test]
    public async Task do_not_update_offer_and_supplement_configuration_pax_when_o4desd_is_zero() {
        //Given
        const string anyO4tipa = "ADULT1";
        const string anyO4dto = "";
    ...
    [Test]
    public async Task do_not_update_offer_and_supplement_configuration_pax_when_o4has_is_zero() {
        //Given
        const string anyO4tipa = "ADULT1";
        const string anyO4dto = "";
        const decimal anyO4desd = 20.00m;
