...
public static class ConcabecExtension {
    public static Contract ToContract(this Concabec concabec) {
        return new Contract {
            ...
            DepositDate = concabec.Coftop != 0 ? DateTimeHelper.ConvertIntegerToNullableDatetime(concabec.Coftop) : null,
    ...
    public static ContractClient ToContractClient(this Concabec concabec) {
        return new ContractClient {
            ...
            ExpiredDate = concabec.Cofext != 0 ? DateTimeHelper.ConvertIntegerToNullableDatetime(concabec.Cofext) : null,
