...
public class CreateIntegration : ICreateIntegration {
    private readonly IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient;

    public CreateIntegration(IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient) {
    ...
    public async Task<HttpResponseMessage> Execute(Usureg usureg) {
        ...
        return await availabilitySynchronizerApiClient.CreateIntegration(client);
    }
}
