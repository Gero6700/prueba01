...
public class CreateOfferSupplementConfigurationPax : ICreateOfferSupplementConfigurationPax {
    private readonly IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient;

    public CreateOfferSupplementConfigurationPax(IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient) {
    ...
    public async Task<HttpResponseMessage> Execute(Condtof condtof) {
        ...
        return await availabilitySynchronizerApiClient.CreateOfferSupplementConfigurationPax(offerAndSupplementConfigurationPax);
    }
}
