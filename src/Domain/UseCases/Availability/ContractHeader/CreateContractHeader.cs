...
public class CreateContractHeader : ICreateContractHeader {
    private readonly IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient;

    public CreateContractHeader(IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient) {
    ...
    public async Task<HttpResponseMessage> Execute(Concabec concabec) {
        ...
        var responseContract = await availabilitySynchronizerApiClient.CreateContractHeader(contract);
        var responseContractClient = await availabilitySynchronizerApiClient.CreateIntegrationContract(contractClient);
