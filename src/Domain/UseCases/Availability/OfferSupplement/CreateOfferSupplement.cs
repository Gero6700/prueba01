...
public class CreateOfferSupplement :ICreateOfferSupplement {
    private readonly IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient;

    public CreateOfferSupplement(IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient) {
    ...
    public async Task<HttpResponseMessage> Execute(Conofege conofege) {
        ...
        return await availabilitySynchronizerApiClient.CreateOfferSupplement(offerAndSupplement);
    }
}
