...
public class UpdateOfferSupplement :IUpdateOfferSupplement {
    private readonly IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient;

    public UpdateOfferSupplement(IAvailabilitySynchronizerApiClient availabilitySynchronizerApiClient) {
    ...
    public Task<HttpResponseMessage> Execute(Conofege conofege) {
        ...
        return availabilitySynchronizerApiClient.UpdateOfferSupplement(offerAndSupplement);
    }
}
